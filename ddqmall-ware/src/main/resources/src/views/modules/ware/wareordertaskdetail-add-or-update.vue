<template>
  <el-dialog
    ...
    <el-form-item label="指定的仓库id" prop="wareId">
      <el-input v-model="dataForm.wareId" placeholder="指定的仓库id"></el-input>
    </el-form-item>
    <el-form-item label="锁定的状态（1:已锁定，2:解锁，3:代表库存已经扣减了）" prop="lockStatus">
      <el-input v-model="dataForm.lockStatus" placeholder="锁定的状态（1:已锁定，2:解锁，3:代表库存已经扣减了）"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          wareId: [
            { required: true, message: '指定的仓库id不能为空', trigger: 'blur' }
          ],
          lockStatus: [
            { required: true, message: '锁定的状态（1:已锁定，2:解锁，3:代表库存已经扣减了）不能为空', trigger: 'blur' }
          ]
        }
      }
    },
